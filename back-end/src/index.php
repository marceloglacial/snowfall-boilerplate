...
<head>
    ...
    <!-- Pre-loads -->
    <link rel="preload" href="<?php bloginfo('template_url'); ?>/assets/css/main.min.css" as="style" />
    <link rel="preload" href="<?php bloginfo('template_url'); ?>/assets/js/main.min.js" as="script" />
